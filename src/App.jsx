...
function AnnouncementBar({ onDismiss }) {
  return (
    <div className="bg-[#E8890C] text-white text-[12px] font-semibold px-4 py-2.5 flex items-center justify-center gap-3 relative z-40">
      ...
      <a href="tel:+19195208118" className="hidden sm:inline-flex items-center gap-1 bg-white/20 hover:bg-white/30 px-3 py-1 rounded-full transition-colors ml-2">
        <I.Phone /> Call Now
      </a>
      ...
      <div className="md:hidden fixed inset-0 z-20 bg-[#0D1B2A] flex flex-col items-center justify-center"
        ...
        <nav className="flex flex-col items-center gap-0 w-full px-8">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 w-full"
            ...
            <a href="tel:+19195208118" onClick={() => setMenuOpen(false)}
          ...
          <Reveal>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-5 pt-2">
                {[
                  { Icon: I.Phone,  label: '(919) 520-8118', sub: 'Mon – Sat · 7am – 7pm' },
            ...
            <div className="p-[5px] rounded-[1.6rem] bg-white ring-1 ring-black/[0.055] shadow-[0_8px_40px_rgba(13,27,42,0.1)]">
              <div className="rounded-[calc(1.6rem-5px)] bg-white p-7 sm:p-8">
                {submitted ? (
                  ...
                  <form onSubmit={async e => { e.preventDefault(); try { const res = await fetch('/api/contact', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(form) }); if (res.ok) setSubmitted(true); else alert('Failed to send. Please call (919) 520-8118 instead.'); } catch { alert('Network error. Please call (919) 520-8118 or email hello@assuranceroofingus.com.'); } }} className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {[{ Icon: I.Phone, t: '(919) 520-8118' }, { Icon: I.Mail, t: 'hello@assuranceroofingus.com' }, { Icon: I.MapPin, t: 'Charlotte, NC 28202' }].map(({ Icon, t }) => (
